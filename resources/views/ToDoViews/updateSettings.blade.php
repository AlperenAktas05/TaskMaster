    ...
    <section class="mt-3 p-3">
        <div class="row">
            ...
            <div class="col-10 px-5">
                <h1 style="color: #7e30e1">Ayarlar</h1>
                <form action="{{route("routeUpdatedSettings")}}" method="post">
                    @csrf
                    <div class="row m-5">
                        <div class="col-6">
                            <div class="input-group input-group-lg">
                                <input type="text" class="form-control" value="{{$name}}" placeholder="Ad Giriniz" aria-label="Username" aria-describedby="basic-addon1" name="name" autocomplete="off" required>
                            </div>
                            <div class="input-group input-group-lg mt-5">
                                <input type="email" class="form-control" value="{{$email}}" placeholder="E-Posta Giriniz" aria-label="Username" aria-describedby="basic-addon1" name="email" autocomplete="off" required>
                            </div>
                            <button type="submit" class="btn text-light mt-5" style="background-color: #7E30E1">Kaydet</button>
                        </div>
                        <div class="col-6">
                            <div class="input-group input-group-lg">
                                <input type="text" class="form-control" value="{{$surname}}" placeholder="Soyad Giriniz" aria-label="Username" aria-describedby="basic-addon1" name="surname" autocomplete="off" required>
                            </div>
                            <div class="input-group input-group-lg mt-5">
                                <input type="password" class="form-control" value="{{$password}}" placeholder="Parola Giriniz" aria-label="Username" aria-describedby="basic-addon1" name="password" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                </form>
