    ...
    <section class="mt-3 p-3">
        <div class="row">
            ...
            <div class="col-10 px-5">
                ...
                <div class="row m-5">
                    <div class="col-6">
                        <h3 style="color: #7e30e1">Ad: <span class="text-secondary">{{$name}}</span></h3>
                        <hr>
                        <h3 class="mt-5" style="color: #7e30e1">Email: <span class="text-secondary">{{$email}}</span></h3>
                        <hr>
                        <a href="{{route("routeUpdateSettings")}}" class="btn text-light mt-5" style="background-color: #7e30e1">Düzenle</a>
                    </div>
                    <div class="col-6">
                        <h3 style="color: #7e30e1">Soyad: <span class="text-secondary">{{$surname}}</span></h3>
                        <hr>
                        <h3 class="mt-5" style="color: #7e30e1">Şifre: <span class="text-secondary">{{$hiddenPassword}}</span></h3>
                        <hr>
                    </div>
                </div>
            </div>
