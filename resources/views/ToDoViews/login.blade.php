    ...
    <section class="mt-5 py-3">
        <div class="row">
            <div class="col-4 offset-4">
                <form action="{{route("routeSubmitLogin")}}" method="post" class="mb-5 shadow p-5 rounded">
                    @csrf
                    ...
                    <div class="mt-5 text-center">
                        <button type="submit" class="btn text-light px-5 py-3 text-center" style="background-color: #7E30E1">Giriş Yap</button>
                    </div>

                    <div class="text-center mt-2">
                        <span>Hesabınız yok mu? <a href="{{route("routeRegister")}}" style="color: #7E30E1; text-decoration: none;">Kayıt Ol</a></span>
                    </div>
                </form>
            </div>
        </div>
